...
![Working principle of a Normalizing Flow](./assets/2spaces.png)
...
[^1]: Tabak, Esteban G. and Eric Vanden-Eijnden, *Density estimation by dual ascent of the log-likelihood* [DOI:10.4310](http://dx.doi.org/10.4310/CMS.2010.v8.n1.a11)

[^2]: Agnellit, J. P. and M. Cadeiras and Tabak, E. G. and Turnert, C. V. and E. Vanden-Eijnden, *Clustering and classification through normalizing flows in feature space* [DOI:10.1137](https://doi.org/10.1137/100783522)
