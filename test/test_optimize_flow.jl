...
@testset "losses and gradients" begin
       ...
       @test (isapprox(negll_rqs_comp_flow_test, 10.981005962569172) &&
              negll_rqs_comp_flow_grad isa NamedTuple{(:flow,), Tuple{NamedTuple{(:_fs,), Tuple{Vector{NamedTuple{(:flow,), Tuple{NamedTuple{(:_fs,), Tuple{Vector{NamedTuple{(:mask, :nn, :nn_parameters, :nn_state), Tuple{Nothing, Nothing, NamedTuple{(:layer_1, :layer_2, :layer_3), Tuple{NamedTuple{(:weight, :bias), Tuple{Matrix{Float32}, Matrix{Float32}}}, NamedTuple{(:weight, :bias), Tuple{Matrix{Float32}, Matrix{Float32}}}, NamedTuple{(:weight, :bias), Tuple{Matrix{Float32}, Matrix{Float32}}}}}, Nothing}}}}}}}}}}}})
